...
extension View {
    ...
    func shakeEffect(shake: Bool, rotation: Double) -> some View {
        self.modifier(ShakeEffect(shake: shake, rotation: rotation))
    }
}

// curtesy of The Fox
// extension to have animation repeat forever based on a Bool
